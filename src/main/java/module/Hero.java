...
public class Hero {
	...
	public String getHeroShowName() { return heroShowName; }
	public String getHeroSpecialPower() { return heroSpecialPower; }
	public int getHeroHp() { return heroHp; }
	public int getHeroAttack() { return heroAttack; }

	public void setHeroHp(int hp) { heroHp = hp; }
	public void setHeroAttack(int attack) { heroAttack = attack; }
}
