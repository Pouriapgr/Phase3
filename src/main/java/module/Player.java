...
public class Player {
    ...
    public Player(String newPlayerUsername, String newPlayerPassword) {
        ...
        playerId = playersAll.getNumberOfAll() + 1;
        playerIdentification = new PlayersId(playerUsername, playerPassword, playerId);
        playersAll.addAllPlayers(playerIdentification);
    ...
    public boolean deletePlayer() {
        ...
        if (password.equals(playerPassword)) {
            PlayersAll playersAll = PlayersAll.loadAllPlayers();
            playersAll.deletePlayer(playerIdentification);
    ...
    public ArrayList<Hero> getPlayerHeroes() {
        return playerAllHeroes;
    }

    public ArrayList<Deck> getPlayerAllDecks() {
        return playerAllDecks;
    }

    public PlayersId getPlayerIdentification() {
